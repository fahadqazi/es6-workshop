...
test(`should be easier to fill an array with values`, () => {
  ...
  var start = 1;
  var end = 5;
  var result = originalArray.fill(value, start, end);
...
test(`should be easy to copy properties from one object to another`, () => {
  ...
  var result = Object.assign({}, source1, source2, source3);
...
/*
http://ws.kcd.im/?ws=ES6+and+Beyond&e=New+APIS&em=fahadqazi@gmail.comYOUR_EMAIL@DOMAIN.COM
*/
